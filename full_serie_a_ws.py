...
print('Iniciando script full_serie_a_ws.py')
#---------------------------------------------------------
#config_default
...
campeonato_json = "save\\classificacao_serie_a.json"

with open(campeonato_json, "w") as arquivo_json:
    json.dump(tabela_campeonato, arquivo_json)


print('classificacao_serie_a executado com sucesso!')

 #----------------- ARTILHARIA, SCRIPT PART 2--------------------------------------
 
artilheiros = {}

print("Iniciando artilharia_ws..")
...
def save_json():
    ...
    artilharia = "save\\artilharia.json"

    with open(artilharia, "w") as arquivo_json:
        json.dump(artilheiros, arquivo_json)

    print('Artilharia salva no arquivo json!')


capture_artilheiros()
save_json()
print("artilharia_ws executado com sucesso!")




#------------------------------- SCRIPTS RODADAS, PART 3 ----------------------------
print('Iniciando script Rodadas Seria A..')
...
def save_json():
    jogos_rodada_json = "save\\jogos_rodada.json"
...
print('full_serie_a_ws.py concluído!')
