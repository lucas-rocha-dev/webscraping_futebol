...
print('Iniciando script full_serie_b_ws.py')
#---------------------------------------------------------
#config_default
...
campeonato_json = "save\\classificacao_serie_b.json"

with open(campeonato_json, "w") as arquivo_json:
    json.dump(tabela_campeonato, arquivo_json)


print('classificacao_serie_b executado com sucesso!')

 #----------------- ARTILHARIA, SCRIPT PART 2--------------------------------------
 
artilheiros = {}

print("Iniciando artilharia_b_ws..")
...
def save_json():
    ...
    artilharia = "save\\artilharia_b.json"

    with open(artilharia, "w") as arquivo_json:
        json.dump(artilheiros, arquivo_json)

    print('Artilharia_b salva no arquivo json!')


capture_artilheiros()
save_json()
print("artilharia__b_ws executado com sucesso!")




#------------------------------- SCRIPTS RODADAS, PART 3 ----------------------------
print('Iniciando script Rodadas Seria B..')
...
def capture_rodada_atual():
   ...
   if numeros:
      ...
      print("Nenhum número encontrado na string rodada.")

def save_json():
    jogos_rodada_json = "save\\jogos_rodada_b.json"
    with open(jogos_rodada_json, "w") as arquivo_json:
        json.dump(rodadas, arquivo_json)

    print('jogos_rodada_b.json salvo com sucesso!')    
   
def save_rodada_atual():
   rodada_atual_end = "save\\rodada_atual_b.json"
   with open(rodada_atual_end, "w") as arquivo_json:
        json.dump(rodada_atual, arquivo_json)

   print('rodada_atual_b.json salva!')    
...
print('full_serie_b_ws.py concluído!')
